...
export function ZoomableVideo(props: any) {
  ...
  const cleanedClassName = (props.className || "").replace(/hover:scale-\[1\.02\]/g, "").replace(/hover:shadow-accent-blue\/20/g, "").replace(/transition-all/g, "").replace(/duration-300/g, "").trim();
